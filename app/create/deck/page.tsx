...
export default function DeckBuilderPage(){
 return <Suspense fallback={<main className="embeddedStudioPage"><header><div className="eyebrow">Interactive customization studio</div><h1>Preparing your Memento Deck…</h1></header></main>}><DeckBuilder/></Suspense>
}
