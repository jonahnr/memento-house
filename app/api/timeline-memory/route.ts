...
export async function POST(request:Request){
 ...
 if(mediaId)await admin.from("media_assets").update({timeline_entry_id:created.data.id,updated_at:new Date().toISOString()}).eq("id",mediaId).eq("wedding_id",weddingId).eq("actor_hash",actorHash).eq("media_type","video").is("timeline_entry_id",null);
