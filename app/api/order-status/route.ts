...
export async function GET(request:Request){
 ...
 let result=await admin.from("orders").select("id,product,tier,order_status,questionnaire_status,customer_email,map_id").eq("stripe_session_id",sessionId).maybeSingle();
