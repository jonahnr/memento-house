...
export function AccountShell({email,mapEnabled=false,children}:{email?:string;mapEnabled?:boolean;children:ReactNode}){
 ...
 return <main className="accountShell">
  ...
  <nav className="accountShellNav" aria-label="Customer account"><a href="#overview">Overview</a><a href="#orders">My orders</a><a href="/cart">Shopping cart</a><a href="#digital">My digital experiences</a><a href="#proofs">Proofs & approvals</a><a href="#profile">Profile & security</a>{mapEnabled&&<details className="accountExperienceMenu"><summary>Memento Map</summary><a href="/dashboard">Open dashboard →</a></details>}</nav>
