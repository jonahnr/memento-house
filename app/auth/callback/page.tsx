...
export default function AuthCallback(){
 ...
 useEffect(()=>{void(async()=>{
  ...
  const client=getSupabaseBrowserClient(),url=new URL(location.href),code=url.searchParams.get("code"),next=url.searchParams.get("next")||"/account",oauthError=url.searchParams.get("error_description");
