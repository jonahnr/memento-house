export type Place={name:string;id:string;lat?:number;lng?:number;precision?:"street-estimate";houseNumber?:string;provider?:"google"};
export type ResolvedPlace=Place&{lat:number;lng:number};
