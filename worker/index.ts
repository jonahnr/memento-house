...
const worker = {
  async fetch(request: Request, env: Env, ctx: ExecutionContext): Promise<Response> {
    ...
    for (const key of ["STRIPE_SECRET_KEY", "STRIPE_WEBHOOK_SECRET", "STRIPE_TEST_SECRET_KEY", "STRIPE_TEST_WEBHOOK_SECRET", "SUPABASE_SERVICE_ROLE_KEY", "ADMIN_EMAILS", "RESEND_API_KEY", "RESEND_FROM_EMAIL", "RESEND_REPLY_TO", "STRIPE_PRICE_MAP_BASIC", "STRIPE_PRICE_MAP_PLUS", "STRIPE_PRICE_DECK_ESSENTIAL", "STRIPE_PRICE_DECK_SIGNATURE", "STRIPE_PRICE_DECK_STORY", "STRIPE_PRICE_DECK_BESPOKE", "STRIPE_PRICE_UNITY_STANDARD", "STRIPE_PRICE_UNITY_BESPOKE"] as const) {
